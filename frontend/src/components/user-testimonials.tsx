    ...
    <Stack>
        ...
        {errorTestimonials? <Text>There has been an error with loading the testimonials.</Text> : 
            ...
            (isAdmin? 
                ...
                <UserTestimonialCard key={index} username={String(testimonial.author_id)} displayName={String(testimonial.author_diplay_name)} slug={testimonial.slug} course_name={testimonial.course_name} yearTaken={String(testimonial.year_taken)} testimonial={String(testimonial.testimonial)} testimonial_approval_status={testimonial.approval_status}></UserTestimonialCard>
...
interface AdminTestimonialCardProps{
    username: String, displayName: String, slug: String, course_name:String, yearTaken: String, testimonial:String, testimonial_id:String, testimonial_approval_status:Number
  }


  interface UserTestimonialCardProps{
    username: String, displayName: String, slug: String, course_name:String, yearTaken: String, testimonial:String, testimonial_approval_status:Number
  }
  
const UserTestimonialCard: React.FC<UserTestimonialCardProps> = ({slug, course_name, username, displayName, yearTaken, testimonial, testimonial_approval_status}) => {
    return(
        <>
...
const AdminTestimonialCard: React.FC<AdminTestimonialCardProps> = ({slug, course_name, username, displayName, yearTaken, testimonial, testimonial_id, testimonial_approval_status}) => {
