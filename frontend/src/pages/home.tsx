...
export default class Home extends React.Component<Props, State> {
  ...
  openFirstCategory = () => {
    ...
    if (this.state.bySemesterView) {
      const categoriesBySemester = fillMetaCategories(
        filtered,
  ...
  render() {
    ...
    if (this.state.gotoCategory) {
      return (
        <Redirect
          to={"/category/" + this.state.gotoCategory.slug}
          push={true}
        />
      );
    }
        ...
        <div {...styles.header}>
          <div {...styles.filterWrapper}>
            <div {...styles.sortWrapper}>
              <span
                onClick={() => this.setBySemesterView(false)}
                {...(this.state.bySemesterView
                  ? styles.sortWrapperInactive
                  : styles.sortWrapperActive)}
              >
                Alphabetical
              </span>{" "}
              |{" "}
              <span
                onClick={() => this.setBySemesterView(true)}
                {...(this.state.bySemesterView
                  ? styles.sortWrapperActive
                  : styles.sortWrapperInactive)}
              >
            ...
            <div {...styles.filterInput}>
              <input
                ...
                placeholder="Filter..."
                autoFocus={true}
                onKeyPress={listenEnter(this.openFirstCategory)}
              />
            </div>
          </div>
