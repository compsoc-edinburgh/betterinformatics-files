...
class TestComment(ComsolTestExamData):
    ...
    def test_flag(self):
        ...
        self.post("/api/exam/setcommentflagged/{}/".format(comment.id), {"flagged": False})
        self.post("/api/exam/setcommentflagged/{}/".format(comment.id), {"flagged": True})
    ...
    def test_mark_as_ai(self):
        ...
        self.post("/api/exam/setcommentmarkedasai/{}/".format(comment.id), {"marked_as_ai": False})
        self.post("/api/exam/setcommentmarkedasai/{}/".format(comment.id), {"marked_as_ai": True})
        comment.refresh_from_db()
