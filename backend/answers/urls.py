...
urlpatterns = [
    ...
    path(
        ...
        views_listings.list_payment_check_exams,
    ...
    path(
        "listbyuser/<str:username>/<int:page>/",
        views_listings.get_by_user,
        name="listbyuser",
    ),
    path(
        "listcommentsbyuser/<str:username>/",
        views_listings.get_comments_by_user,
        name="listcommentsbyuser",
    ),
    path(
        "listcommentsbyuser/<str:username>/<int:page>/",
        views_listings.get_comments_by_user,
        name="listcommentsbyuser",
    ),
    ...
    path(
        "cutversions/<str:filename>/", views_cuts.get_cut_versions, name="cutversions"
    ),
    path(
    ...
    path(
        "remove/printonly/<str:filename>/",
        views_files.remove_printonly,
        name="remove_printonly",
    ),
    path(
        "remove/solution/<str:filename>/",
        views_files.remove_solution,
        name="remove_solution",
    ),
    path("pdf/exam/<str:filename>/", views_files.get_exam_pdf, name="get_exam_pdf"),
    path(
        "pdf/solution/<str:filename>/",
        views_files.get_solution_pdf,
        name="get_solution_pdf",
    ),
    path(
        "pdf/printonly/<str:filename>/",
        views_files.get_printonly_pdf,
        name="get_printonly_pdf",
    ),
    path("printpdf/exam/<str:filename>/", views_files.print_exam, name="printexam"),
    path(
        "printpdf/solution/<str:filename>/",
        views_files.print_solution,
        name="printsolution",
    ),
]
