...
urlpatterns = [
    ...
    path('setanswerflagged/<int:oid>/', views_answers.set_flagged, name='setanswerflagged'),
    path('setanswermarkedasai/<int:oid>/', views_answers.set_marked_as_ai, name='setanswermarkedasai'),
    path('resetanswerflagged/<int:oid>/',
         views_answers.reset_flagged, name='resetanswerflagged'),
    path('resetanswermarkedasai/<int:oid>/',
         views_answers.reset_marked_as_ai, name='resetanswermarkedasai'),
    ...
    path('setcommentflagged/<int:oid>/', views_comments.set_flagged, name='setcommentflagged'),
    path('setcommentmarkedasai/<int:oid>/', views_comments.set_marked_as_ai, name='setcommentmarkedasai'),
    path('resetcommentflagged/<int:oid>/',
         views_comments.reset_flagged, name='resetcommentflagged'),
    path('resetcommentmarkedasai/<int:oid>/',
         views_comments.reset_marked_as_ai, name='resetcommentmarkedasai'),
