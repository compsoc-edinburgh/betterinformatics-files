...
urlpatterns = [
    ...
    path(
        "<str:username>/<str:summary_slug>/comments/",
        views.SummaryCommentRootView.as_view(),
        name="comments_root",
    ),
    path(
        "<str:username>/<str:summary_slug>/comments/<int:id>/",
        views.SummaryCommentElementView.as_view(),
        name="comments_element",
    ),
    path(
        "<str:username>/<str:summary_slug>/files/",
        views.SummaryFileRootView.as_view(),
        name="files_root",
    ),
    path(
        "<str:username>/<str:summary_slug>/files/<int:id>/",
