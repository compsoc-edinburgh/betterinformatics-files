...
urlpatterns = [
    ...
    path(
        "<str:username>/<slug:document_slug>/comments/",
        views.DocumentCommentRootView.as_view(),
        name="comments_root",
    ),
    path(
        "<str:username>/<slug:document_slug>/comments/<int:id>/",
        views.DocumentCommentElementView.as_view(),
        name="comments_element",
    ),
    path(
        "<str:username>/<slug:document_slug>/files/",
        views.DocumentFileRootView.as_view(),
        name="files_root",
    ),
    path(
        "<str:username>/<slug:document_slug>/files/<int:id>/",
